...
@dataclass
class Droplet3D_PipelineOutput(BaseOutput):
    r"""
...
class Droplet3D_Pipeline_Inpaint(DiffusionPipeline):
    r"""
    ...
    def __call__(
    ...
    ) -> Union[Droplet3D_PipelineOutput, Tuple]:
        """
        ...
        return Droplet3D_PipelineOutput(videos=video)
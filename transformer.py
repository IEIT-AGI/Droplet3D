...
class Droplet3DPatchEmbed(nn.Module):
    def __init__(
            self,
            patch_size: int = 2,
            in_channels: int = 16,
...
class Droplet3DBlock(nn.Module):
    r"""
...
class Droplet3DTransformer3DModel(ModelMixin, ConfigMixin):
    """
    ...
    def __init__(
        ...
        # 1. Patch embedding
        self.patch_embed = Droplet3DPatchEmbed(patch_size, in_channels, inner_dim, text_embed_dim, bias=True)
